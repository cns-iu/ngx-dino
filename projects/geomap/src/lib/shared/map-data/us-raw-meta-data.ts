export type CompactCountyMetaData = [number, string]; // [id, name]
export type CompactStateMetaData = [number, string, string, CompactCountyMetaData[]]; // [id, code, name, counties]

export const rawUSMetaData: CompactStateMetaData[] = [
  [1, 'AL', 'Alabama', [
    [1000, 'Alabama'],
    [1001, 'Autauga'],
    [1003, 'Baldwin'],
